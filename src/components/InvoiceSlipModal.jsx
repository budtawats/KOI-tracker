    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-3 sm:p-6 animate-fadeIn">
      <div className="bg-white rounded-3xl shadow-2xl max-w-xl w-full max-h-[95vh] flex flex-col overflow-hidden border border-gray-100">
        ...
        <div className="p-6 overflow-y-auto flex-1 bg-gray-100/60 flex justify-center">
          ...
          >
            {/* Red top border bar */}
            <div className="absolute top-0 left-0 right-0 h-2.5 bg-gradient-to-r from-red-600 to-amber-500 rounded-t-2xl"></div>

            {/* Slip Header */}
            <div className="text-center pt-2 space-y-1.5">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-tr from-red-600 to-amber-500 text-white font-black text-xl shadow-md shadow-red-500/20 mb-1">
                KOI
              </div>
              <h2 className="text-xl font-black text-gray-900 tracking-tight">{shopName}</h2>
              <p className="text-xs font-semibold text-red-600">ใบแจ้งยอดค่าน้ำหนัก & สรุปรายการสินค้าพรีออเดอร์</p>
              <div className="pt-2 flex justify-center">
                <span className="font-mono text-sm font-black text-white bg-red-600 px-4 py-1 rounded-xl shadow-sm tracking-wider">
                  {order.id}
                </span>
              </div>
            </div>
